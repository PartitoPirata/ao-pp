    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="<?php if($_GET['file'] == 'streaming'){ echo 'active';} ?>"><a href="<?php echo $base_url; ?>streaming/">Diretta assemblea<sup><small>STREAM+CHAT</small></sup></a></li>
          <li class="<?php if($_GET['file'] == 'chat'){ echo 'active';} ?>"><a target="_blank" href="<?php echo $base_url; ?>chat/">Diretta assemblea<sup><small>SOLO CHAT</small></sup></a></li>
